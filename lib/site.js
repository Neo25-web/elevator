...
export const site = {
  ...
  youtube: "https://www.youtube.com/@JamilMughal805",
  serviceAreas: [
    "Daska",
    "Sialkot",
    "Lahore",
  ...
  items: [
    {
      ...
      desc: "Heavy-duty geared traction machines for freight lifts and quiet gearless machines for passenger and capsule lifts, sized to each project's load and speed requirements.",
    },
    {
      icon: "🧠",
      title: "VVVF Control System",
      desc: "Microprocessor-based VVVF drives deliver smooth acceleration, precise floor levelling, and lower power consumption compared to conventional two-speed control.",
    },
    {
      icon: "🛡️",
      title: "Safety Gear & Governor",
      desc: "Every lift is fitted with an overspeed governor and progressive safety gear that grip the guide rails and bring the car to a controlled stop if speed exceeds safe limits.",
    },
    {
      icon: "🔩",
      title: "Guide Rails & Ropes",
      desc: "Machined steel guide rails and high-tensile steel wire ropes with generous safety factors ensure stable, vibration-free travel and a long service life.",
    },
    {
      icon: "🚪",
      title: "Automatic Door Operators",
      desc: "VVVF automatic door operators with light-curtain protection for passenger lifts, plus robust manual and swing-door options for freight and low-rise installations.",
    },
    {
      icon: "🔋",
      title: "ARD (Auto Rescue Device)",
      desc: "During a power failure the ARD automatically brings the lift to the nearest floor and opens the doors — essential for Pakistan's load-shedding conditions.",
    },
  ],
};
